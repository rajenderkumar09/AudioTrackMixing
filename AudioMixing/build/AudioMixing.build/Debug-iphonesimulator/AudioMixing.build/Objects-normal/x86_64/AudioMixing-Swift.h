...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AudioMixing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11AudioMixing11AppDelegate")
...
SWIFT_CLASS("_TtC11AudioMixing6Looper")
...
@interface Looper (SWIFT_EXTENSION(AudioMixing)) <AVAudioPlayerDelegate>
...
@property (nonatomic, copy) IBOutletCollection(UILabel) NSArray<UILabel *> * _Null_unspecified trackLabel;
...
@interface RootViewController (SWIFT_EXTENSION(AudioMixing))
/// Dismiss or Hide Picker view
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
@end


@interface RootViewController (SWIFT_EXTENSION(AudioMixing)) <UIPickerViewDataSource, UIPickerViewDelegate>
...
SWIFT_CLASS("_TtC11AudioMixing13SceneDelegate")
